...
- Name: intern-dashboard.spec.ts >> Assertions >> Add Intern Journey >> does not add intern when form is invalid
- Location: tests\intern-dashboard.spec.ts:193:1
...
- generic [ref=f1e3]:
  ...
  - generic [ref=f1e7]:
    ...
    - list
    - generic [ref=f1e11]:
      - paragraph [ref=f1e12]: Name is required
      - textbox "Name" [ref=f1e13]
      - spinbutton "Score" [ref=f1e14]: "0"
      - checkbox [checked] [ref=f1e15]
      - text: Present
      - combobox [ref=f1e16]:
        - option "Frontend" [selected]
        - option "Backend"
        - option "Fullstack"
      - button "Add Intern" [active] [ref=f1e17]
      - button "Reset" [ref=f1e18]
    - generic [ref=f1e19]:
      - textbox "Search Intern" [ref=f1e20]
      - heading "Statistics" [level=3] [ref=f1e21]
      - paragraph [ref=f1e22]: "Total Interns: 0"
      - paragraph [ref=f1e23]: "Present: 0"
      - paragraph [ref=f1e24]: "Average Score: 0"
      - heading "Filtered Interns" [level=3] [ref=f1e25]
```
